...
-- Inserisci admin (esegui prima questo script PHP per generare l'hash corretto)
INSERT INTO personale (email, password_hash, primo_accesso, tema_background) 
VALUES ('admin@fastroute.it', '$2y$12$ItkfKsx8kxD6LN1EyspIZOEOTa.qC1rkg2tvVpDIYVvcvDSqAyyk2', 1, 'light');
